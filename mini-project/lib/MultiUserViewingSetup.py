...
class User:
    ...
    def __init__(self,
        ...
        self.resolve_pass.EnvironmentLightingColor.value = avango.gua.Color(0.4, 0.4, 0.4)
        ...
        # self.resolve_pass.BackgroundTexture.value = "/opt/guacamole/resources/skymaps/DayTime_Clear_01.jpg"
